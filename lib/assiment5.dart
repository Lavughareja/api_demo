...
class Assiment5 extends StatefulWidget {
  const Assiment5({Key? key}) : super(key: key);

  @override
  State<Assiment5> createState() => Assiment5taste();
}

class Assiment5taste extends State<Assiment5> {
  double? _rating;
